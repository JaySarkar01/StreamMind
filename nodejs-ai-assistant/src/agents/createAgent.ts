...
import { GeminiAgent } from "./openai/GeminiAgent";   // 👈 use your GeminiAgent
...
export const createAgent = async (
  ...
  switch (platform) {
    ...
    case AgentPlatform.GEMINI:   // 👈 fixed
      return new GeminiAgent(chatClient, channel);   // 👈 fixed
    default:
